...
class VladimirPutin extends Person
{
	...
	public function agreePeaceWith(Area $area)
	{
		...
		case 'Finland' && date('Y') === 1944:
			...
			$stalin->say("... but, on a second thought, I might have to consider the several losses we've had recently. It might be that I can't afford any new casualties, although I wouldn't be responsible for them anyway.");
